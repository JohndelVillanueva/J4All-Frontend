    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-center min-h-screen gap-8">
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 lg:w-2/5 max-w-lg rounded-2xl shadow-2xl border border-gray-100 p-8 relative z-10 backdrop-blur-xl bg-white/70 dark:bg-gray-900/60"
          ref={formRef}
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {userType === 'pwd' && (
                <div className="space-y-2 col-span-2">
                  <label htmlFor="pwdIdNumber" className="block text-sm font-medium text-white">
                    PWD ID Number
                  </label>
                  <input
                    id="pwdIdNumber"
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="agreeToTerms" className="text-white">
                    I agree to the{' '}
                    <a href="#" className="text-indigo-200 hover:text-indigo-100 underline">
                      Terms of Service
                    </a>{' '}
                    and{' '}
                    <a href="#" className="text-indigo-200 hover:text-indigo-100 underline">
